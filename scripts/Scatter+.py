...
if not "Scattered" in obj:
    ...
    [[-62.6,167.375],[0,0,0],'ammoCrate'],
    [[-48.6,97.7],[0,0,0],'ammoCrate'],
    [[52.9376,97.2075],[0,0,0],'ammoCrate'],
    [[119.737,-15.6217],[0,0,0],'ammoCrate'],
    [[28.2387,-99.2614],[0,0,0],'ammoCrate'],
    [[54.0603,10.1999],[0,0,0],'ammoCrate'],
    [[5,5,0],[0,0,0],'MP_Main'],
